                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                ...
                                                <form method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <a href="https://with.hu" class="d-none d-lg-block d-xl-block btn btn-outline-primary float-left btn-inline">Mi az a <span class="brand-text mb-0 with-logo" style="color: #47b272; font-weight: 600;
