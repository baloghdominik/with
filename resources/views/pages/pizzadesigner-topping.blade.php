...
@section('title', 'Pizza Designer - Toppings')
...
<section id="basic-horizontal-layouts">
    <div class="row match-height">
        ...
        <div class="col-md-8 col-12">
            <div class="card" style="">
                <div class="card-header">
                    <h4 class="card-title">Pizza Feltétek - {{ $data->size }} cm</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="mb-1 mt-2">Zöldségek</h5>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover-animation mb-0">
                                        <thead>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="mb-1 mt-2">Gyümölcsök</h5>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover-animation mb-0">
                                        <thead>
        ...
        <div class="col-md-8 col-12">
            <div class="card" style="">
                <div class="card-header">
                    <h4 class="card-title">Új Pizza Feltét</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
