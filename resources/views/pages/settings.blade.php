...
<div class="row match-height">
    ...
    <div class="col-md-8 col-12">
        <div class="card" style="">
            ...
            <div class="card-content">
                <div class="card-body">
                <form class="form form-horizontal" method="post" action="/withadmin/public/update-settings"  enctype="multipart/form-data">
                        <div class="form-body">
                            <div class="row">
                                @csrf
                                <div class="col-12">
    ...
    <div class="col-md-8 col-12">
        <div class="card" style="">
            ...
            <div class="card-content">
                <div class="card-body">
                <form class="form form-horizontal" method="post" action="/withadmin/public/upload-images"  enctype="multipart/form-data">
                        <div class="form-body">
                            <div class="row">
                                @csrf 
                                <div class="col-12 mb-3">
