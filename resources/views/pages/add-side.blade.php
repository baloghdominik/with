                        ...
                        <div class="col-md-8 col-12">
                            <div class="card" style="">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="{{ url('add-side') }}"  enctype="multipart/form-data">
                                            <div class="form-body">
                                                <div class="row">
                                                    @csrf 
                                                    <div class="col-12">
...
<div class="row match-height">
    <div class="col-md-12 col-12">
        ...
        <button type="button" class="close" data-dismiss="alert">×</button>
            <strong>Új köret feltöltése nem lehetséges, mert még hozott létre kategóriákat.</strong><br/>
