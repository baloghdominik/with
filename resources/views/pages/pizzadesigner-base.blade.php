                                    ...
                                    <table class="table table-hover-animation mb-0">
                                        ...
                                        <tbody>
                                            @foreach($pizzadesigner_bases as $key => $base)
                                                ...
                                                <tr>
                                                    @php 
                                                        if (file_exists("images/pizzadesigner/".$base->art.".png")) {
                                                            $img = "images/pizzadesigner/".$base->art.".png";
                                                        } else {
                                                    ...
                                                    @if(($base->price - $base->makeprice) <= 0)
                                                    <td style="color: #e42728;">{{number_format(($base->price - $base->makeprice), 0)}} Ft</td>
                                                    @else
