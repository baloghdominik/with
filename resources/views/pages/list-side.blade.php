                    ...
                    <div class="col-lg-10 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Köret lista</h4>
                            </div>
                            <div class="card-content">
                                ...
                                <table class="table table-responsive table-striped mb-0">
                                    ...
                                    @foreach($side as $key => $data)
                                        ...
                                        @endif
                                            <td><img src="images/sides/{{$data->picid}}.jpg" width="100%" height="auto" style="border-radius: 0.5rem;"></td>
                                            <td><b>{{$data->name}}</b></td>
                                            ...
                                            <td><a href="edit-side/{{$data->id}}" class="btn btn-icon btn-outline-primary mr-1 mb-1 waves-effect waves-light"><i class="feather icon-edit"></i></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
