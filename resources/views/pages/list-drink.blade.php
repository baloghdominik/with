...
@endif
    ...
    <div class="row">
        <div class="col-12">
        <a href="{{ url('add-drink') }}" class="btn btn-outline-primary mr-1 mb-1 waves-effect waves-light">Új ital</a>
        </div>
    </div>
                            ...
                            <div class="card-content">
                                ...
                                <table class="table table-responsive table-striped mb-0">
                                    ...
                                    @foreach($drink as $key => $data)
                                        ...
                                        @endif
                                        @php 
                                                if (file_exists("images/drinks/".$data->picid.".jpg")) {
                                                    $img = "images/drinks/".$data->picid.".jpg";
                                                } else {
