                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card" style="">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ url('update-drink/'.$drink->id) }}"  enctype="multipart/form-data">
                                            <div class="form-body">
                                                <div class="row">
                                                    @csrf 
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            @php 
                                                                if (file_exists("images/drinks/".$drink->picid.".jpg")) {
                                                                    $img = "images/drinks/".$drink->picid.".jpg";
                                                                } else {
                        ...
                        <div class="col-md-8 col-sm-12">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <h4 class="card-title">Ital törlése</h4>
                                    </div>
                                    <div class="card-body">
                                        <form method="post" action="{{ url('delete-drink') }}">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-md-4">
