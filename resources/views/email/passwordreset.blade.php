                 ...
                 <tr> 
                  <td class="es-m-p0r es-m-p20b" width="444" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-infoblock es-m-txt-c" align="left"><p style="color: #8b8a8a">Elfelejtette a jelszavát? Az alábbi link használatával állíthat be új jelszót!</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="560" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td align="left"><h2 class="title_w" style="font-size: 26px;text-align: center;color: #47b272"><strong>Jelszó helyreállítás!</strong></h2></td> 
                     </tr> 
                     ...
                     <tr> 
                      <td class="es-p5t es-p5b"><p>Amennyiben nem ön kérvényezte a jelszava helyreállítását, nincs további teendője, hagyja figyelmen kívül ezt az emailt.</p></td> 
                     </tr> 
                     <tr> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="580" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                      <tr> 
                      <td class="es-p10t" align="center"><p style="font-size: 12px">Kérjük erre az email-re ne válaszoljon!</p></td> 
                     </tr>
                     <tr> 
                      <td class="" align="center"><p style="font-size: 12px">Probléma esetén keresse ügyfélszolgálatunkat az alábbi email címen!</p></td> 
                     </tr> 
                     <tr> 
                      <td class="es-p10b" align="center"><p style="font-size: 12px;color: #47b272"><a style="font-size: 12px;color: #47b272; text-decoration:none;" href="MAILTO:info@with.hu">info@with.hu</a></p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="560" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-infoblock es-p20b" align="center" style="font-size: 0px"><a target="_blank" href="https://with.hu"><img src="{{ asset('images/With_Logo_SmallResolution.png') }}" width="125" style="display: block" height="66"></amp-img></a></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
